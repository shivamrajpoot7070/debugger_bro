<h2><a href="https://leetcode.com/problems/minimum-sensors-to-cover-grid/">3648. Minimum Sensors to Cover Grid</a></h2><h3>Medium</h3><hr><p>You are given <code>n &times; m</code> grid and an integer <code>k</code>.</p>
